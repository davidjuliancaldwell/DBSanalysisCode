...
OUTPUT_DIR = pwd;
save(sprintf(['stimSpacingDBS-%s-stim_%d-%d'], sid, stimChans(1),stimChans(2)),'dataEpoched','stimChans','t','singEpoched','stim1Epoched','middlePts_1st','middlePts_2nd');
