function [processedSig, processedSig_cell,recon_artifact,recon_artifact_cell,t] =  ica_train_dbs(tTotal,data,stimChans,fs_data,scale_factor,numComponentsSearch,plotIt,channelInt,meanSub,orderPoly,pre,post)
...
%individual trial. This is for trains of stimuli FOR DBS 
%
